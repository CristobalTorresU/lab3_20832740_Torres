 ...
 */
public class TextoPlano_20832740_TorresUndurraga extends File_20832740_TorresUndurraga {
    // Métodos
    // Constructor
    public TextoPlano_20832740_TorresUndurraga(String nombre, String extension, String contenido, String ruta){
        this.nombre = nombre;
